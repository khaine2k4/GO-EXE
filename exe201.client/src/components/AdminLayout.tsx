...
import { ArrowLeft, Banknote, Bell, BriefcaseBusiness, ChevronLeft, CircleDollarSign, FolderTree, LifeBuoy, LogOut, Menu, MessageSquare, Percent, ShieldCheck, Users, X } from 'lucide-react'
